...
namespace Appalachia.Core.Trees
{
    ...
    public class LogRuntimeInstance : InternalInstancedMonoBehaviour
    {
        ...
        [BoxGroup("Log"), ReadOnly]
        public string logName;

        [BoxGroup("Log"), ReadOnly, HideInInspector]
        public int logID;

        [BoxGroup("Log")]
        public WoodSimulationData wood;
        ...
        [BoxGroup("Properties"), ReadOnly, ShowInInspector]
        public float mass => rigidbodyDensityManager.rb.mass;

        [BoxGroup("Instancing"), PropertyRange(0f, 1f)]
