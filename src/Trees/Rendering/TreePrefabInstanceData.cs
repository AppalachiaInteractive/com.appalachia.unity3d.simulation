...
namespace Appalachia.Simulation.Trees.Rendering
{
    ...
    public class TreePrefabInstanceData
    {
        ...
        public bool IsStump =>
            (currentStage == StageType.Stump) || (currentStage == StageType.StumpRotted);
        ...
        public bool IsBare =>
            (currentStage == StageType.FelledBare) || (currentStage == StageType.FelledBareRotted);

        public bool CanCut =>
            !IsFelled &&
            ((IsNormal &&
              (prefabData.prototypes.felled != null) &&
              (prefabData.prototypes.stump != null)) ||
             (IsDead &&
              (prefabData.prototypes.deadFelled != null) &&
              (prefabData.prototypes.stump != null)));
        ...
        public bool CanBare =>
            !IsBare && !IsDead && IsFelled && (prefabData.prototypes.felledBare != null);
