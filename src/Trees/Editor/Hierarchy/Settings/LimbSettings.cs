...
namespace Appalachia.Simulation.Trees.Hierarchy.Settings
{
    ...
    public class LimbSettings : AgeOverrideResponsiveSettings, ICloneable<LimbSettings>
    {
        ...
        private static readonly string[] SearchStrings = new[] {"break", "wood", "ring"};
        ...
        [HideInInspector]
        public floatTree weldNormalBlendSize = TreeProperty.New(4f);
        [HideInInspector]
        public floatTree weldNormalBlend = TreeProperty.New(.25f);
