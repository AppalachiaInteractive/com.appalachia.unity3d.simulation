...
namespace Appalachia.Simulation.Trees.Hierarchy.Settings
{
    ...
    {
        [PropertyTooltip(
            "How far apart trunks can be spread.")]
        ...
        [PropertyTooltip("Defines the noise of the flares, lower values will give a more wobbly look, while higher values gives a more stochastic look.")]
