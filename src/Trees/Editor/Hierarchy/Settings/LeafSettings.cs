...
namespace Appalachia.Simulation.Trees.Hierarchy.Settings
{
    ...
    public class LeafSettings : AgeOverrideResponsiveSettings, ICloneable<LeafSettings>
    {
        ...
        private static readonly string[] ExcludedSearchStrings_Branch = { "_atlas", "_tiled", "_snapshot" };
        private static readonly string[] ExcludedSearchStrings_Tree = { "_atlas", "_tiled" };

        private static readonly string[] SearchStrings = { "leaf", "twig", "branch", "leave" };
        ...
        private bool _showSpokeCount =>
            (geometryMode == LeafGeometryMode.Spoke) || (geometryMode == LeafGeometryMode.BentSpoke);
        ...
        #region ICloneable<LeafSettings> Members
