...
namespace Appalachia.Simulation.Trees.Hierarchy.Settings
{
    ...
    public class BranchSettings : AgeOverrideResponsiveSettings, ICloneable<BranchSettings>
    {
        ...
        private bool showBranch => (geometryMode == BranchGeometryMode.Branch) ||
            (geometryMode == BranchGeometryMode.BranchFrond);

        private bool showFrond =>
            ((geometryMode == BranchGeometryMode.Frond) || (geometryMode == BranchGeometryMode.BranchFrond)) && !hideLog;
        ...
        private static readonly string[] SearchStrings = new[] {"bark", "wood", "branch", "trunk"};
        ...
        [FormerlySerializedAs("lengthRelativeToParentAllowed")] [HideInInspector]
