...
namespace Appalachia.Simulation.Trees.Hierarchy.Settings
{
    ...
    public class DistributionSettings : AgeOverrideResponsiveSettings, ICloneable<DistributionSettings>
    {
        ...
        [PropertyTooltip(
            "Use the curve to fine tune position, rotation and scale. " +
        ...
        public AnimationCurveTree distributionCurve = TreeProperty.Curve(0f, .6f, .9f, 1f, .6f, 0f);
        ...
        [TreeProperty]
        [OnValueChanged(nameof(DistributionSettingsChanged), true)]
        public DistributionRadialModeTree radial = TreeProperty.New(DistributionRadialMode.Equal);

        [PropertyTooltip("The way that the shapes are distributed along their parent.")]
        [TreeProperty]
        [OnValueChanged(nameof(DistributionSettingsChanged), true)]
        public DistributionVerticalModeTree vertical = TreeProperty.New(DistributionVerticalMode.Equal);
        ...
        #region ICloneable<DistributionSettings> Members
