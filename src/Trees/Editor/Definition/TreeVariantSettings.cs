...
namespace Appalachia.Simulation.Trees.Definition
{
    ...
    public class TreeVariantSettings : ResponsiveSettings
    {
        ...
        [PropertyTooltip(
            "Adjusts the likelihood the the fungi will spawn when the tree is alive.")]
        ...
        [TabGroup("Fungus", Paddingless = true)]
        [PropertyTooltip(
            "Adjusts the likelihood the the fungi will spawn when the tree is dead.")]
        ...
        [TabGroup("Fungus", Paddingless = true)]
        [PropertyTooltip(
            "Adjusts the likelihood the the fungi will spawn when the tree is rotted.")]
