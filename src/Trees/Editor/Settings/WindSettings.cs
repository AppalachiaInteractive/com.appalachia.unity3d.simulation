...
namespace Appalachia.Simulation.Trees.Settings
{
    ...
    public class WindSettings : ResponsiveSettings
    {
        ...
        [PropertyTooltip(
            "Adjusts whether vertex wind data should be normalized to a 0 to 1 range..")]
        [ToggleLeft]
        [OnValueChanged(nameof(VertexDataSettingsChanged))]
        ...
        [PropertyTooltip(
            "Adjusts the amount of growth per meter of trunk.")]
        ...
        [PropertyTooltip(
            "Increases the trunk dead zone, per meter of tree height..")]
        [PropertyRange(0f, 1f)]
        [BoxGroup("Wind/Mesh Settings/Trunk", CenterLabel = true)]
        ...
        [PropertyTooltip(
            "Increases the amount of wind bend on the trunk depending on its length.")]
        ...
        [PropertyTooltip(
            "Increases the amount of wind bend on child branches.")]
        [PropertyRange(.9f, 2f)]
        [HorizontalGroup("Wind/Mesh Settings/Branch/A", .33f)]
