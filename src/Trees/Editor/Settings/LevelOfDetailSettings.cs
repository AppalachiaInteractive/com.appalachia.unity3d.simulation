...
namespace Appalachia.Simulation.Trees.Settings
{
    ...
    public class LevelOfDetailSettings : ResponsiveSettings
    {
        ...
        [HideIf(nameof(hideTreeSettings))]
        [PropertyTooltip(
            "Whether to add additional spline samples when teh child is fungi, knots, or fruits."
        )]
        ...
        [HideIf(nameof(hideTreeSettings))]
        [PropertyTooltip(
            "Whether to add additional spline samples at child offsets (to improve vertex data quality."
        )]
        [HorizontalGroup("$title/E")]
        [LabelWidth(65)]
        [PropertySpace, ToggleLeft]
        ...
        [PropertyTooltip(
            "Adjusts the quality of branches relative to the tree's LOD Quality, so that it is of either higher or lower quality than the rest of the tree."
        )]
        [PropertyRange(0f, 2f)]
        ...
        //[HideIf(nameof(hideTreeSettings))]
        [PropertyTooltip(
            "Width of the cross-fade transition zone (proportion to the current LODs whole length)."
        )]
        [PropertyRange(0f, 1f)]
        ...
        [HideIf(nameof(hideTreeSettings))]
        [PropertyTooltip(
            "Adjusts the quality of leaves relative to the tree's LOD Quality, so that it is of either higher or lower quality than the rest of the tree."
        )]
        [PropertyRange(0f, 2f)]
        [HorizontalGroup("$title/B")]
        ...
        [HideIf(nameof(hideTreeSettings))]
        [PropertyTooltip(
            "Adjusts the quality of roots relative to the tree's LOD Quality, so that it is of either higher or lower quality than the rest of the tree."
        )]
        [PropertyRange(0f, 2f)]
        ...
        [PropertyTooltip(
            "Adjusts the quality of trunks relative to the tree's LOD Quality, so that it is of either higher or lower quality than the rest of the tree."
        )]
        [PropertyRange(0f, 2f)]
        [HorizontalGroup("$title/A")]
