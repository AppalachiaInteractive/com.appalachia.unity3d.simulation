...
namespace Appalachia.Simulation.Trees.Build.Execution
{
    public static class TreeBuildManagerMenu
    {
        ...
        [MenuItem("Tools/Tree Tool/Trees/Enable Build" + SHC.CTRL_ALT_SHFT_T, true)]
        ...
        [MenuItem("Tools/Tree Tool/Trees/Enable Build" + SHC.CTRL_ALT_SHFT_T)]
        ...
        [MenuItem("Tools/Tree Tool/Trees/Metadata/Rebuild Individual Metadata")]
