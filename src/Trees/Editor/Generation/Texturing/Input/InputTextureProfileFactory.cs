...
namespace Appalachia.Simulation.Trees.Generation.Texturing.Input
{
    public static class InputTextureProfileFactory
    {
        public static InputTextureProfile Albedo =>
            ...
            {
                red = new InputTextureProfileChannel { mapChannel = TextureMapChannel.Albedo_R },
                green = new InputTextureProfileChannel { mapChannel = TextureMapChannel.Albedo_G },
                blue = new InputTextureProfileChannel { mapChannel = TextureMapChannel.Albedo_B },
                alpha = new InputTextureProfileChannel { mapChannel = TextureMapChannel.Opacity }
            };

        public static InputTextureProfile AlbedoDetail =>
            new InputTextureProfile(TextureMap.AlbedoDetail)
            {
                red = new InputTextureProfileChannel { mapChannel = TextureMapChannel.AlbedoDetail_R },
                green = new InputTextureProfileChannel { mapChannel = TextureMapChannel.AlbedoDetail_G },
                blue = new InputTextureProfileChannel { mapChannel = TextureMapChannel.AlbedoDetail_B },
        ...
        public static InputTextureProfile AlbedoDisplacement =>
            new InputTextureProfile(TextureMap.AlbedoDisplacement)
            {
                ...
                green = new InputTextureProfileChannel { mapChannel = TextureMapChannel.Albedo_G },
                blue = new InputTextureProfileChannel { mapChannel = TextureMapChannel.Albedo_B },
                alpha = new InputTextureProfileChannel { mapChannel = TextureMapChannel.Displacement }
            };
        ...
        public static InputTextureProfile AlbedoGlossiness =>
            new InputTextureProfile(TextureMap.AlbedoGlossiness)
            {
                ...
                green = new InputTextureProfileChannel { mapChannel = TextureMapChannel.Albedo_G },
                blue = new InputTextureProfileChannel { mapChannel = TextureMapChannel.Albedo_B },
                alpha = new InputTextureProfileChannel { mapChannel = TextureMapChannel.Glossiness }
            };
        ...
        public static InputTextureProfile AlbedoRoughness =>
            new InputTextureProfile(TextureMap.AlbedoRoughness)
            {
                ...
                green = new InputTextureProfileChannel { mapChannel = TextureMapChannel.Albedo_G },
                blue = new InputTextureProfileChannel { mapChannel = TextureMapChannel.Albedo_B },
                alpha = new InputTextureProfileChannel { mapChannel = TextureMapChannel.Roughness }
            };

        public static InputTextureProfile AmbientOcclusion =>
            new InputTextureProfile(TextureMap.AmbientOcclusion)
            {
                red = new InputTextureProfileChannel { mapChannel = TextureMapChannel.AmbientOcclusion }
            };

        public static InputTextureProfile Bump =>
            new InputTextureProfile(TextureMap.Bump)
            {
                red = new InputTextureProfileChannel { mapChannel = TextureMapChannel.Bump }
            };

        public static InputTextureProfile Cavity =>
            new InputTextureProfile(TextureMap.Cavity)
            {
                red = new InputTextureProfileChannel { mapChannel = TextureMapChannel.Cavity }
            };

        public static InputTextureProfile Concavity =>
            new InputTextureProfile(TextureMap.Concavity)
            {
                red = new InputTextureProfileChannel { mapChannel = TextureMapChannel.Concavity }
            };

        public static InputTextureProfile Convexity =>
            new InputTextureProfile(TextureMap.Convexity)
            {
                red = new InputTextureProfileChannel { mapChannel = TextureMapChannel.Convexity }
            };

        public static InputTextureProfile Custom =>
            new InputTextureProfile(TextureMap.Custom)
            {
                red = new InputTextureProfileChannel { mapChannel = TextureMapChannel.None },
                green = new InputTextureProfileChannel { mapChannel = TextureMapChannel.None },
                blue = new InputTextureProfileChannel { mapChannel = TextureMapChannel.None },
                alpha = new InputTextureProfileChannel { mapChannel = TextureMapChannel.None }
            };

        public static InputTextureProfile Derivative =>
            new InputTextureProfile(TextureMap.Derivative)
            {
                red = new InputTextureProfileChannel { mapChannel = TextureMapChannel.Derivative_X },
                green = new InputTextureProfileChannel { mapChannel = TextureMapChannel.Derivative_Y }
            };

        public static InputTextureProfile DetailMap =>
            new InputTextureProfile(TextureMap.DetailMap)
            {
                red = new InputTextureProfileChannel { mapChannel = TextureMapChannel.NormalBump_TS_X },
                green = new InputTextureProfileChannel { mapChannel = TextureMapChannel.NormalBump_TS_Y },
                blue = new InputTextureProfileChannel { mapChannel = TextureMapChannel.NormalBump_TS_Z },
                alpha = new InputTextureProfileChannel { mapChannel = TextureMapChannel.AlbedoDetail_BW }
            };

        public static InputTextureProfile DetailMapPacked =>
            new InputTextureProfile(TextureMap.DetailMapPacked)
            {
                red = new InputTextureProfileChannel { mapChannel = TextureMapChannel.AlbedoDetail_BW },
                green = new InputTextureProfileChannel { mapChannel = TextureMapChannel.NormalBump_TS_Y },
                blue = new InputTextureProfileChannel { mapChannel = TextureMapChannel.NormalBump_TS_Z },
                alpha = new InputTextureProfileChannel { mapChannel = TextureMapChannel.NormalBump_TS_X }
            };

        public static InputTextureProfile DetailMask =>
            new InputTextureProfile(TextureMap.DetailMask)
            {
                red = new InputTextureProfileChannel { mapChannel = TextureMapChannel.DetailMask }
            };

        public static InputTextureProfile Displacement =>
            new InputTextureProfile(TextureMap.Displacement)
            {
                red = new InputTextureProfileChannel { mapChannel = TextureMapChannel.Displacement }
            };
        ...
        public static InputTextureProfile DualChannelCurvature =>
            ...
            {
                red = new InputTextureProfileChannel { mapChannel = TextureMapChannel.Concavity, },
                green = new InputTextureProfileChannel { mapChannel = TextureMapChannel.Convexity }
            };

        public static InputTextureProfile Emission =>
            new InputTextureProfile(TextureMap.Emission)
            {
                red = new InputTextureProfileChannel { mapChannel = TextureMapChannel.Normal_OS_X },
                green = new InputTextureProfileChannel { mapChannel = TextureMapChannel.Normal_OS_Y },
                blue = new InputTextureProfileChannel { mapChannel = TextureMapChannel.Normal_OS_Z },
                alpha = new InputTextureProfileChannel { mapChannel = TextureMapChannel.Displacement }
            };
        ...
        public static InputTextureProfile Glossiness =>
            ...
            {
                red = new InputTextureProfileChannel { mapChannel = TextureMapChannel.Glossiness }
            };

        public static InputTextureProfile MAOHS =>
            new InputTextureProfile(TextureMap.MAOHS)
            {
                red = new InputTextureProfileChannel { mapChannel = TextureMapChannel.Metallicity },
                green =
                    new InputTextureProfileChannel { mapChannel = TextureMapChannel.AmbientOcclusion },
                blue = new InputTextureProfileChannel { mapChannel = TextureMapChannel.Displacement },
                alpha = new InputTextureProfileChannel { mapChannel = TextureMapChannel.Glossiness }
            };
        ...
        public static InputTextureProfile MAOTS =>
            new InputTextureProfile(TextureMap.MAOTS)
            {
                ...
                green =
                    new InputTextureProfileChannel { mapChannel = TextureMapChannel.AmbientOcclusion },
                blue = new InputTextureProfileChannel { mapChannel = TextureMapChannel.Transmission },
                alpha = new InputTextureProfileChannel { mapChannel = TextureMapChannel.Glossiness }
            };
        ...
        public static InputTextureProfile Normal_TS =>
            ...
            {
                red = new InputTextureProfileChannel { mapChannel = TextureMapChannel.Normal_TS_X },
                green = new InputTextureProfileChannel { mapChannel = TextureMapChannel.Normal_TS_Y },
                blue = new InputTextureProfileChannel { mapChannel = TextureMapChannel.Normal_TS_Z }
            };

        public static InputTextureProfile NormalBump_OS =>
            new InputTextureProfile(TextureMap.NormalBump_OS)
            {
                red = new InputTextureProfileChannel { mapChannel = TextureMapChannel.NormalBump_OS_X },
                green = new InputTextureProfileChannel { mapChannel = TextureMapChannel.NormalBump_OS_Y },
                blue = new InputTextureProfileChannel { mapChannel = TextureMapChannel.NormalBump_OS_Z }
            };
        ...
        public static InputTextureProfile NormalTSSpecularityMap =>
            ...
            {
                red = new InputTextureProfileChannel { mapChannel = TextureMapChannel.SetToZero },
                green = new InputTextureProfileChannel { mapChannel = TextureMapChannel.Normal_TS_Y },
                blue = new InputTextureProfileChannel
                {
                    mapChannel = TextureMapChannel.Specularity_Strength
                },
                alpha = new InputTextureProfileChannel { mapChannel = TextureMapChannel.Normal_TS_X }
            };
        ...
        public static InputTextureProfile NormalTSSpecularityOcclusionMap =>
            new InputTextureProfile(TextureMap.NormalTSSpecularityOcclusionMap)
            {
                ...
                green = new InputTextureProfileChannel { mapChannel = TextureMapChannel.Normal_TS_Y },
                blue = new InputTextureProfileChannel { mapChannel = TextureMapChannel.AmbientOcclusion },
                alpha = new InputTextureProfileChannel { mapChannel = TextureMapChannel.Normal_TS_X }
            };
        ...
        public static InputTextureProfile Opacity =>
            ...
            {
                red = new InputTextureProfileChannel { mapChannel = TextureMapChannel.Opacity }
            };

        public static InputTextureProfile Roughness =>
            new InputTextureProfile(TextureMap.Roughness)
            {
                red = new InputTextureProfileChannel { mapChannel = TextureMapChannel.Roughness }
            };

        public static InputTextureProfile ShadowMap =>
            new InputTextureProfile(TextureMap.ShadowMap)
            {
                red = new InputTextureProfileChannel { mapChannel = TextureMapChannel.Shadow },
                green = new InputTextureProfileChannel { mapChannel = TextureMapChannel.SetToZero },
                blue = new InputTextureProfileChannel { mapChannel = TextureMapChannel.SetToZero },
                alpha = new InputTextureProfileChannel { mapChannel = TextureMapChannel.SetToOne }
            };
        ...
        public static InputTextureProfile Specularity =>
            ...
            {
                red = new InputTextureProfileChannel { mapChannel = TextureMapChannel.Specularity_R },
                green = new InputTextureProfileChannel { mapChannel = TextureMapChannel.Specularity_G },
                blue = new InputTextureProfileChannel { mapChannel = TextureMapChannel.Specularity_B },
            };
        ...
        public static InputTextureProfile Transmission =>
            ...
            {
                red = new InputTextureProfileChannel { mapChannel = TextureMapChannel.Transmission }
            };

        public static InputTextureProfile Variant_Albedo =>
            new InputTextureProfile(TextureMap.Variant_Albedo)
            {
                red = new InputTextureProfileChannel { mapChannel = TextureMapChannel.Variant_Albedo_R },
                green =
                    new InputTextureProfileChannel { mapChannel = TextureMapChannel.Variant_Albedo_G },
                blue = new InputTextureProfileChannel { mapChannel = TextureMapChannel.Variant_Albedo_B },
                alpha = new InputTextureProfileChannel { mapChannel = TextureMapChannel.Variant_Opacity }
            };
        ...
        public static InputTextureProfile Variant_Glossiness =>
            ...
            {
                red = new InputTextureProfileChannel { mapChannel = TextureMapChannel.Variant_Glossiness }
            };
        ...
        public static InputTextureProfile Variant_MAOHS =>
            ...
            {
                red =
                    new InputTextureProfileChannel { mapChannel = TextureMapChannel.Variant_Metallicity },
                green = new InputTextureProfileChannel
                {
                    mapChannel = TextureMapChannel.Variant_AmbientOcclusion
                },
        ...
        public static InputTextureProfile Variant_NormalTSSpecularityOcclusionMap =>
            new InputTextureProfile(TextureMap.Variant_NormalTSSpecularityOcclusionMap)
            {
                ...
                green =
                    new InputTextureProfileChannel { mapChannel = TextureMapChannel.Variant_Normal_TS_Y },
                blue = new InputTextureProfileChannel
                {
                    mapChannel = TextureMapChannel.Variant_AmbientOcclusion
                },
        ...
        public static InputTextureProfile Variant_Opacity =>
            ...
            {
                red = new InputTextureProfileChannel { mapChannel = TextureMapChannel.Variant_Opacity }
            };

        public static InputTextureProfile Variant_Roughness =>
            new InputTextureProfile(TextureMap.Variant_Roughness)
            {
                red = new InputTextureProfileChannel { mapChannel = TextureMapChannel.Variant_Roughness }
            };
        ...
        public static InputTextureProfile Variant_SpecularityGlossiness =>
            ...
            {
                red =
                    new InputTextureProfileChannel
                    {
                        mapChannel = TextureMapChannel.Variant_Specularity_R
                    },
                green = new InputTextureProfileChannel
