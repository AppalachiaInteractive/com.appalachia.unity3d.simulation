...
namespace Appalachia.Simulation.Trees.UI.Base
{
        ...
        where T : TSEDataContainer
    {
        ...
        protected abstract HierarchyData CreateHierarchy(IHierarchyWrite hierarchies, TreeComponentType type, HierarchyData parent);
        ...
        public void DrawGraph(T so, ITreeStatistics statistics, IHierarchyReadWrite hierarchies, IShapeRead shapes)
        {
            using (var rect = TreeGUI.Layout.Horizontal())
            {
                if (settings == null)
                {
                    var setGuid = AssetDatabaseManager.FindAssets($"t: {typeof(TreeGraphSettings).Name}").FirstOrDefault();

                    if (setGuid != null)
                    {
                        settings = AssetDatabaseManager.LoadAssetAtPath<TreeGraphSettings>(
                ...
                if (so.graphDirty)
                {
                    TreeGraph.Rebuild(hierarchies, shapes, selection, TreeGraphSettings.instance);
                    so.graphDirty = false;
                }
                ...
                if (shapes != null)
                {
                    try
                    {
                        TreeGraph.Draw(so,selection,  hierarchies, shapes, TreeGraphSettings.instance, statistics, rect.rect);
                    }
                    catch
                    {
                        TreeGraph.Rebuild(hierarchies, shapes, selection, TreeGraphSettings.instance);
            ...
            float buttonSpaceWidth)
        {
            ...
            using (TreeGUI.Layout.Horizontal(false))
            {
                ...
                TreeGUI.Button.EnableDisable(
                    ...
                    TreeGUI.Layout.Options.Height(buttonHeight).ExpandHeight(false).ExpandWidth().MaxWidth(buttonSize)
                );
                ...
                TreeGUI.Button.EnableDisable(
                    ...
                    () =>
                    {
                        ...
                        var h = CreateHierarchy(hierarchies, TreeComponentType.Root, TreeGraph.selectedHierarchy);
                ...
                TreeGUI.Button.EnableDisable(
                    ...
                    () =>
                    {
                        ...
                        var h = hierarchies.CreateHierarchy(TreeComponentType.Knot, TreeGraph.selectedHierarchy, null);
                ...
                TreeGUI.Button.EnableDisable(
                    ...
                    () =>
                    {
                        ...
                        var h = CreateHierarchy(hierarchies, TreeComponentType.Fungus, TreeGraph.selectedHierarchy);
                ...
                TreeGUI.Button.EnableDisable(
                    ...
                    () =>
                    {
                        ...
                        var h = CreateHierarchy(hierarchies, TreeComponentType.Branch, TreeGraph.selectedHierarchy);
                ...
                TreeGUI.Button.EnableDisable(
                    ...
                    () =>
                    {
                        ...
                        var h = CreateHierarchy(hierarchies, TreeComponentType.Leaf, TreeGraph.selectedHierarchy);
                ...
                TreeGUI.Button.EnableDisable(
                    ...
                    () =>
                    {
                        ...
                        var h = CreateHierarchy(hierarchies, TreeComponentType.Fruit, TreeGraph.selectedHierarchy);
