        ...
        protected override void DrawAdditionalToolbar(float width, float height)
        {
            var branchCreateHierarchyAction = new Action<TreeComponentType>(
                type =>
                {
                    ...
                    {
                        h = branch.branch.hierarchies.CreateTrunkHierarchy(
                    ...
                    if (parent != null)
                    {
                        ...
                        {
                            var siblings = branch.branch.hierarchies
                                                 .GetHierarchiesByParent(parent.hierarchyID)
            ...
            var addBranchEnabled = HasSelection &&
                                   (branch != null) &&
                                   HasSelection &&
                                   ((Selected.type == TreeComponentType.Trunk) ||
                                    (Selected.type == TreeComponentType.Branch));
            ...
            using (TreeGUI.Layout.Vertical())
            {
                ...
                using (TreeGUI.Enabled.If(HasSelection))
                {
                        ...
                        ))
                    {
                        ...
                        branch.branch.hierarchies.DeleteHierarchyChain(
                            branch.branch.shapes,
