...
namespace Appalachia.Simulation.Buoyancy.Data
{
    ...
    public class BuoyancyData : SelfSavingScriptableObject<BuoyancyData>
    {
        ...
        [EnableIf(nameof(overrideDefaultWetnessAccumulationSpeed)), SmartLabel]
        ...
        [EnableIf(nameof(overrideDefaultWetnessDispersalSpeed)), SmartLabel]
        [PropertyRange(0.00001f, 0.01f)]
        [SerializeField]
        ...
        [EnableIf(nameof(overrideDefaultSubmergednessAccumulationSpeed)), SmartLabel]
        [PropertyRange(0.00001f, 0.01f)]
        [SerializeField]
        ...
        [EnableIf(nameof(overrideDefaultSubmergednessDispersalSpeed)), SmartLabel]
        [PropertyRange(0.00001f, 0.01f)]
        [SerializeField]
        ...
        /// </summary>
        [EnableIf(nameof(overrideDefaultBuoyancyType)), SmartLabel]
        [SerializeField]
        ...
        /// </summary>
        [EnableIf(nameof(overrideVoxelPopulationStyle)), SmartLabel]
        [SerializeField]
        ...
        /// </summary>
        [EnableIf(nameof(overrideDefaultVoxelResolution)), SmartLabel]
        ...
        [EnableIf(nameof(overrideDefaultSubmersionEngageSmoothing)), SmartLabel]
        ...
        [EnableIf(nameof(overrideDefaultSubmersionDisengageSmoothing)), SmartLabel]
        [PropertyRange(0.01f, 1.0f)]
        [SerializeField]
        ...
        public Mesh mesh
        {
            ...
            {
                _mesh = value;
                UnityEditor.AssetDatabase.TryGetGUIDAndLocalFileIdentifier(_mesh, out _meshGUID, out long _);
            }
            #endif
        }
